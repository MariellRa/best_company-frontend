...
if company == 'Apple':
    ...
    with st.expander("Comprehensive Analysis of Results"):
        for i in range(2):
            if list(sorted_variable_dict)[i] == keyword1:
            ...
            if list(sorted_variable_dict)[i] == keyword2:
            ...
            if list(sorted_variable_dict)[i] == keyword3:
            ...
            if list(sorted_variable_dict)[i] == keyword4:
            ...
            if list(sorted_variable_dict)[i] == keyword5:
            ...
            if list(sorted_variable_dict)[i] == keyword6:
            ...
            if list(sorted_variable_dict)[i] == keyword7:
            ...
            if list(sorted_variable_dict)[i] == keyword8:
            ...
            if list(sorted_variable_dict)[i] == keyword9:
            ...
            if list(sorted_variable_dict)[i] == keyword10:
