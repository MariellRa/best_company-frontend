...
if company == 'Apple':
    ...
    wordcloud_apple = WordCloud(width=800, height=400, background_color='white', contour_width=3, contour_color='steelblue', random_state=42).generate(apple)
    fig, ax = plt.subplots()
...
if company == 'Meta':
    ...
    wordcloud_meta = WordCloud(max_font_size=60, background_color='white', colormap='Paired').generate(meta)
...
if company == 'Microsoft':
    ...
    wordcloud_microsoft = WordCloud(max_font_size=60, background_color='white', colormap='Paired').generate(microsoft)
...
if company == 'Amazon':
    ...
    wordcloud_amazon = WordCloud(max_font_size=60, background_color='white', colormap='Paired').generate(amazon)
...
if company == 'Google':
    ...
    wordcloud_google = WordCloud(max_font_size=60, background_color='white', colormap='Paired').generate(google)
