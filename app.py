...
if sum(list(response.json()['sorted_company'].values())) == 0:
    ...
    if company == 'Apple':
        ...
        with st.expander("Your compatibility analysis"):
            ...
            for i in range(1,2):
                if list(sorted_variable_dict)[i][0] == keyword1:
                    Y = f'In addition, {company_name} is exceptional when it comes to career growth, as they provide a wide variety of training programs, mentoring opportunities, and resources to help employees develop their professional skills and expand their knowledge. The company is deeply committed to recognizing and promoting talent, ensuring that individuals have clear paths for advancement and can successfully achieve their career goals.'
                if list(sorted_variable_dict)[i][0] == keyword2:
                    Y = f'In addition, {company_name} shines in creating a positive work environment that promotes employee well-being and satisfaction. They prioritize fostering a supportive atmosphere where individuals feel valued and motivated to thrive. By offering various perks, work-life balance initiatives, and opportunities for professional development, they ensure that employees can flourish in a fulfilling work environment.'
                if list(sorted_variable_dict)[i][0] == keyword3:
                    Y = f'In addition, {company_name} values work-life balance as a crucial aspect of their company culture. They understand the importance of maintaining a healthy equilibrium between work and personal life. By offering flexible work arrangements, wellness programs, and supportive policies, they empower employees to manage their professional responsibilities while tending to their personal well-being.'
                if list(sorted_variable_dict)[i][0] == keyword4:
                    Y = f'In addition, {company_name} demonstrates a strong commitment to diversity and inclusion within their organization. They actively promote an inclusive work environment that values and respects individuals from all backgrounds and identities. By fostering diversity, they create a space where employees feel empowered to contribute their unique perspectives and experiences, leading to innovation and growth.'
                if list(sorted_variable_dict)[i][0] == keyword5:
                    Y = f'In addition, {company_name} is at the forefront of utilizing technology to drive innovation and enhance productivity. They embrace the latest technological advancements to streamline processes and empower their employees with efficient tools and resources. By leveraging technology, they create a dynamic work environment that promotes collaboration, creativity, and efficiency.'
                if list(sorted_variable_dict)[i][0] == keyword6:
                    Y = f'In addition, {company_name} stands out when it comes to compensation. They offer a wide array of benefits and rewards to recognize and appreciate their employees efforts. With competitive salaries, bonuses based on performance, and attractive incentives, they make sure employees are fairly rewarded. Additionally, they prioritize recognizing talent and supporting career growth, giving individuals opportunities to advance and earn the compensation they deserve.'
                if list(sorted_variable_dict)[i][0] == keyword7:
                    Y = f'In addition, {company_name} distinguishes itself with its people-centric culture that places employees at the heart of the organization. They prioritize creating a supportive and inclusive work environment where individuals feel valued, respected, and empowered. Through their comprehensive compensation packages, professional development opportunities, and recognition programs, they demonstrate their commitment to nurturing a culture that values and invests in their people.'
                if list(sorted_variable_dict)[i][0] == keyword8:
                    Y = f'In addition, {company_name} places a strong emphasis on teamwork and collaboration within their organization. They foster a culture that values the power of collective effort and encourages employees to work together towards shared goals. By promoting effective communication, cross-functional projects, and a supportive team environment, they enable employees to maximize their potential and achieve success collectively.'
                if list(sorted_variable_dict)[i][0] == keyword9:
                    Y = f'In addition, {company_name} excels in providing exceptional learning and development opportunities for their employees. They understand the significance of continuous growth and offer a range of training programs, workshops, and resources to enhance professional skills. By prioritizing learning and development, they empower individuals to reach their full potential and succeed in their careers, complementing their competitive compensation structure.'
                if list(sorted_variable_dict)[i][0] == keyword10:
                    Y = f'In addition, {company_name} distinguishes itself through its attention to role scope, ensuring that employees have well-defined responsibilities and opportunities for growth. They prioritize providing clear job descriptions, outlining the expectations and parameters of each role within the organization. By offering clarity in role scope, employees can understand their contributions, excel in their positions, and receive the compensation that aligns with their responsibilities.'
            st.write("-", X)
            st.write(" ")
            st.write("-", Y)
    ...
    if company == 'Microsoft':
        ...
        with st.expander("Reviews most people found helpful"):
            ...
            st.write(" ")
            st.write("Review 2")
            st.write("- :green[**Pros**]: Decent pay, good benefits, great co-workers.")
            st.write("- :red[**Cons**]: Satya does regular layoffs, while talking a big game about caring for employees. This fiscal year, Microsoft acquired companies worth a 100B, invested 10B+ in OpenAI, but laid off 5% of the workforce to save $1-2B over the next few years.")
            st.write(" ")
            st.write("Review 3")
    ...
    if company == 'Google':
        ...
        with st.expander("Reviews most people found helpful"):
            ...
            st.write(" ")
            st.write("Review 2")
            st.write("- :green[**Pros**]: The money’s great! The free gourmet food and snacks are never-ending Working at Google, you're exposed to amazing people and great thinkers Googlers feel like they are really living in the future Dogs are welcome!") 
            st.write("- :red[**Cons**]: Learning is self-driven The competition is brutal Supervision is minimal.")
            st.write(" ")
            st.write("Review 3")
    ...
    st.write(" ")
    st.write(" ")
    with st.expander(":gray[Disclaimer: Data Analysis and Recommendations Based on Current Internet Data]")
        st.write(":gray[At Company Name, we strive to provide accurate and up-to-date information and recommendations to our users. However, it is important to note that our data analysis and recommendations depend on the volume of data extracted from the internet at a certain moment in time.We collect information from various sources across the internet, including websites, databases, and other publicly available information. The data we analyze is subject to change, as websites and online platforms update their content or algorithms.While we make every effort to ensure the reliability and accuracy of our data analysis, we cannot guarantee the completeness or timeliness of the information presented. Factors such as website updates, changes in algorithms, or other external events can impact the validity of our analysis. Therefore, it is important to use our recommendations as a general guide and consider additional research and verification before making any decisions. We strongly advise users to independently verify the information provided and take into account the dynamic nature of online data.[Your Company Name] shall not be held liable for any inaccuracies, errors, or omissions in the data analysis or recommendations provided on our platform. Users of our service agree to use the information at their own risk and understand that our recommendations are based on the data available at a specific point in time.We encourage users to reach out to us if they notice any discrepancies or have concerns about the information presented on our website. We will make every effort to address and rectify any issues promptly.]")
        st.write(":gray[Please note that the recommendations and information provided on our platform are not intended to replace professional advice or serve as the sole basis for decision-making. We recommend consulting with relevant experts or professionals before making any significant choices or commitments.By using our services, you acknowledge and agree to this disclaimer, understanding the limitations of data analysis based on internet-extracted information.If you have any questions or require further clarification, please contact us at *contact information*.]")
        st.write(":gray[Last updated: Date. Please note that it is important to consult with legal professionals to ensure that the disclaimer meets any specific legal requirements and is tailored to your company’s circumstances.]")
