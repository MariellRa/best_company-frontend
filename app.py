...
'''
st.sidebar.write("To begin the process, we kindly ask you to rate ten keywords to reflect your preferences. These keywords will help our algorithm identify the best matching companies for you based on your specified criteria.
