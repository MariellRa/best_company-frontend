...
# Variable 2 Slider
variable2 = st.sidebar.slider(f'Set {keyword2}: 0-10', 0, 10, 0)
# Variable 3 Slider
variable3 = st.sidebar.slider(f'Set {keyword3}: 0-10', 0, 10, 0)
# Variable 4 Slider
variable4 = st.sidebar.slider(f'Set {keyword4}: 0-10', 0, 10, 0)
# Variable 5 Slider
variable5 = st.sidebar.slider(f'Set {keyword5}: 0-10', 0, 10, 0)
# Variable 6 Slider
variable6 = st.sidebar.slider(f'Set {keyword6}: 0-10', 0, 10, 0)
# Variable 7 Slider
variable7 = st.sidebar.slider(f'Set {keyword7}: 0-10', 0, 10, 0)
# Variable 8 Slider
variable8 = st.sidebar.slider(f'Set {keyword8}: 0-10', 0, 10, 0)
# Variable 9 Slider
variable9 = st.sidebar.slider(f'Set {keyword9}: 0-10', 0, 10, 0)
# Variable 10 Slider
variable10 = st.sidebar.slider(f'Set {keyword10}: 0-10', 0, 10, 0)
