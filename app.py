...
if sum(list(response.json()['sorted_company'].values())) == 0:
    st.write(" ")
    st.write(":exclamation: No results yet!)
...
with st.expander("Disclaimer: Data Analysis and Recommendations Based on Current Internet Data"):
    ...
    st.write("Last updated: Date. Please note that it is important to consult with legal professionals to ensure that the disclaimer meets any specific legal requirements and is tailored to your company’s circumstances.")
