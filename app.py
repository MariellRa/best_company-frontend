...
if company == 'Meta':
    ...
    with st.expander("Reviews most people found helpful"):
        st.write("Review 1")
        st.write("- **Pros**: Good perks and comp, coworkers are nice and fun.") 
        ...
        st.write(" ")
        st.write("Review 2")
        st.write("- **Pros**: Great opportunity to work with the smartest people from the world - most products have billions of users so your work have a big scope - beautiful campus, good snacks, foods, and benefits.")
        ...
        st.write(" ")
        st.write("Review 3")
        st.write("- **Pros**: Food - Health care benefits - Fringe benefits - Nice campus - Corporate shuttles - State of the art tech stack - Extremely smart coworkers - Visionary and bold top management.") 
...
if company == 'Microsoft':
    ...
    with st.expander("Reviews most people found helpful"):
        st.write("Review 1")
        st.write("- **Pros**: Brand; serves as a launchpad + Scope of work is broad + Lots of learnings- both technical and management skills.") 
        ...
        st.write(" ")
        st.write("Review 2")
        st.write("- **Pros**: Decent pay, good benefits, great co-workers.")
        ...
        st.write(" ")
        st.write("Review 3")
        st.write("- **Pros**: Working with truly big datasets and ability to use advanced techniques Cutting edge database/stats tools Relaxed environment with no deadlines and pressure.") 
...
if company == 'Amazon':
    ...
    with st.expander("Reviews most people found helpful"):
        ...
        st.write(" ")
        st.write("Review 3")
        st.write("- **Pros**: Flexible working hours work from home there are many smart people around you who are more than willing to share their knowledge.") 
...
if company == 'Google':
    ...
    with st.expander("Reviews most people found helpful"):
        st.write("Review 1")
        st.write("- **Pros**: Great tech infrastructure systems, but it's hard to know which ones to use. This is usually served by having senior team members who know what they're doing, but teams in Finance generally don't have that (employee churn).")
        ...
        st.write(" ")
        st.write("Review 2")
        st.write("- **Pros**: The money’s great! The free gourmet food and snacks are never-ending Working at Google, you're exposed to amazing people and great thinkers Googlers feel like they are really living in the future Dogs are welcome!") 
        st.write("- **Cons**: Learning is self-driven The competition is brutal Supervision is minimal.")
        st.write(" ")
        st.write("Review 3")
        st.write("- **Pros**: Great job security Clear path to promotion Smart colleagues Excellent career development resources Diverse workplace Creative freedom and autonomy Effective feedback processes.") 
